...
fn main() {
    ...
    let total_points: i64 = input.trim().parse().unwrap();
    // Initialize the counter for the number of points inside the circle
    let mut inside_circle: i64 = 0;
    ...
    for _ in 0..total_points {
        ...
        let distance: f64 = x.powi(2) + y.powi(2);
    ...
    let pi_aproximation: f64 = 4.0 * (inside_circle as f64 / total_points as f64);
